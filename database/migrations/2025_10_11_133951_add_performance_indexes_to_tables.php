...
return new class extends Migration
{
    ...
    {
        // Students table indexes - already created in previous migration
        // Schema::table('students', function (Blueprint $table) {
        //     $table->index('enrollment_status');
        //     $table->index(['grade_id', 'class_section_id']);
        // });

        // Homework table indexes - already created in previous migration
        ...
        // Homework submissions table indexes - already created in previous migration
        // Schema::table('homework_submissions', function (Blueprint $table) {
        //     $table->index(['homework_id', 'student_id']);
        //     $table->index('status');
        // });

        // Payment transactions table indexes - already created in previous migration
        ...
        // Student fees table indexes - already created in previous migration
        // Schema::table('student_fees', function (Blueprint $table) {
        //     $table->index('payment_status');
        //     $table->index(['student_id', 'academic_year_id']);
        // });

        // Results table indexes - columns don't match
        // Schema::table('results', function (Blueprint $table) {
        //     $table->index(['student_id', 'term_id']);
        //     $table->index('academic_year_id');
        // });

        // Teachers table indexes - status column doesn't exist
